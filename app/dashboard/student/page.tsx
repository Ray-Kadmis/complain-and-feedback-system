      ...
      <div className="container mx-auto py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button
                className="w-full"
                onClick={() => router.push("/dashboard/student/make-complaint")}
              >
                Make a Complaint
              </Button>
            </CardContent>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button
                className="w-full"
                onClick={() =>
                  router.push("/dashboard/student/previous-complaints")
                }
              >
                View History
              </Button>
        ...
        >
          <DialogContent
            ...
            hideCloseButton={!!selectedComplaint}
          >
            <DialogHeader>
              <DialogTitle>Confirm Resolution</DialogTitle>
              <DialogDescription>
                This complaint has been marked as resolved by faculty. Please
                confirm if the issue has actually been resolved.
              </DialogDescription>
            </DialogHeader>
            {selectedComplaint && (
              <div className="space-y-4 py-4">
                <div className="space-y-1">
                  ...
                  <p className="text-sm">
                    {selectedComplaint.category.charAt(0).toUpperCase() +
                      selectedComplaint.category.slice(1)}{" "}
                    \{" "}
                    {selectedComplaint.subcategory.charAt(0).toUpperCase() +
                      selectedComplaint.subcategory.slice(1)}
                  </p>
                </div>
                <div className="space-y-1">
