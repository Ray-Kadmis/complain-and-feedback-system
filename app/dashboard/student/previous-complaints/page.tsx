...
export default function PreviousComplaints() {
  ...
  const fetchPreviousComplaints = async (userId: string) => {
    try {
      ...
      complaintsData.sort((a, b) => b.updatedAt.getTime() - a.updatedAt.getTime())
        ...
        <CardContent>
          {loading ? (
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {complaint.category.charAt(0).toUpperCase() + complaint.category.slice(1)} • Submitted:{" "}
                          {complaint.createdAt.toLocaleDateString()} • Resolved:{" "}
            ...
            <div className="text-center py-10">
              <p className="text-muted-foreground">You don't have any previous complaints</p>
